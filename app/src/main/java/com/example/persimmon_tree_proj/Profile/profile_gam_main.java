...
public class profile_gam_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        color.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {  //색상 버튼 누르면 색깔 정하는 곳으로 가게
                Intent intent = new Intent(getApplicationContext(), profile_color_main.class); //코드 생성 activity로 이동
                    ...
                    switch (view.getId()) {
                        case R.id.gam1:
                            ...
                            if (clicked_arr[0] == 1) {
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("1");
                            }
                            make_clicked();
                            break;
                        case R.id.gam2:
                            if (clicked_arr[1] == 1) {
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("2");
                            }
                            make_clicked();
                            break;
                        case R.id.gam3:
                            if (clicked_arr[2] == 1) {
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("3");
                            }
                            make_clicked();
                            break;
                        case R.id.gam4:
                            if(clicked_arr[3] == 1){ clicked_arr[3] = 0; } else if(clicked_arr[3] ==0){
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("4");
                            }
                            make_clicked();
                            break;
                        case R.id.gam5:
                            if(clicked_arr[4] == 1){ clicked_arr[4] = 0; } else if(clicked_arr[4] ==0){
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("5");
                            }
                            make_clicked();
                            break;
                        case R.id.gam6:
                            if(clicked_arr[5] == 1){ clicked_arr[5] = 0; } else if(clicked_arr[5] ==0){
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("6");
                            }
                            make_clicked();
                            break;
                        case R.id.gam7:
                            if(clicked_arr[6] == 1){ clicked_arr[6] = 0; } else if(clicked_arr[6] ==0){
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("7");
                            }
                            make_clicked();
                            break;
                        case R.id.gam8:
                            if(clicked_arr[7] == 1){ clicked_arr[7] = 0; } else if(clicked_arr[7] ==0){
                                ...
                                FirebaseDatabase.getInstance().getReference("family").child(myfcode).child("members").child(user.getUid()).child("user_gam").setValue("8");
                            }
                            make_clicked();
                            break;
