...
public class popup_DeletePlan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup__delete_plan);
        ...
        member_plan = (TextView) findViewById(R.id.member_plan);
        ...
        yearmonth_text.setText(year + "년 " + month + "월 " + day + "일 ");
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child(f_code).child("calendar").child(year).child(month).child(day).child(user_name).child(plan_id).removeValue();
                Intent intent = new Intent(getApplicationContext(), ShareCalendarActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra("f_code",f_code);
                overridePendingTransition(0, 0); //intent시 효과 없애기
                startActivity(intent);
                Toast.makeText(popup_DeletePlan.this, "선택한 일정이 삭제 되었다감! ", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
