...
public class Registeractivity_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register2); //registeractivity 와 연결
        ...
        btn_view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Registeractivity_2.this, servicehtml.class);
        ...
        btn_view2.setOnClickListener(new View.OnClickListener() {//개인정보 연결
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Registeractivity_2.this, privacyhtml.class);
                startActivity(intent);
            }
        });
            ...
            public void onClick(View v) {  //모든 정보 입력했는지 확인
                ...
                if (!name.equals("") && !birth.equals("")) {
                    ...
                    if (TERMS_AGREE_1 == 0 || TERMS_AGREE_2 == 0) {
                        // 첫번째 약관 체크여부
                            Toast.makeText(Registeractivity_2.this, "필수 약관에 동의해주세요", Toast.LENGTH_SHORT).show();
                            return;
                    }
                    // 전체 약관 체크된경우
                    else {
                        ...
                        if(ok1 == 1){//비밀번호가 최소 8자 , 영어 대소문 , 숫자, 특수문자 사용 가능
                            ...
                            Toast.makeText(Registeractivity_2.this, "생년월일은 8자로 써주세요 ex)20200912", Toast.LENGTH_LONG).show();   //비밀번호를 다시 입력하는 알림
                    ...
                    Toast.makeText(Registeractivity_2.this, "회원정보를 모두 입력해주세요.", Toast.LENGTH_LONG).show();   //알림 메세지 띄움
                }
            }
        });
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {  //auth에 올리는 task
                        if (task.isSuccessful()) {   //auth에 업로드에 성공했다면
                            ...
                            mDatabase.child("users").child(uid).setValue(usermodel)//database에 users 안에 usermodel의 내용으로 업로드
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) { //database에 올리기 성공했으면
                                            Toast.makeText(Registeractivity_2.this, "회원가입이 완료되었습니다", Toast.LENGTH_SHORT).show();
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {  //database에 올리기 실패했으면
                                            Toast.makeText(Registeractivity_2.this, "회원가입에 실패했습니다.", Toast.LENGTH_SHORT).show();
                            ...
                            // 계정이 중복된 경우
                            Toast.makeText(Registeractivity_2.this, "중복되는 계정이 있습니다.", Toast.LENGTH_SHORT).show();
